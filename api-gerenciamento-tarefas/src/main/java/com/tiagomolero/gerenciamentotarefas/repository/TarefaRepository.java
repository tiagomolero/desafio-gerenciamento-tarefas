...
public interface TarefaRepository extends JpaRepository<Tarefa, UUID> {
    ...
    List<Tarefa> findByCriadorIdAndPrioridade(UUID criadorId, Prioridade prioridade);
    List<Tarefa> findByCriadorIdAndStatus(UUID criadorId, Status status);
    List<Tarefa> findByCriadorIdAndStatusAndPrioridade(UUID criadorId, Status status, Prioridade prioridade);
}
